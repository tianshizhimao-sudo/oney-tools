    ...
    try {
      ...
      const response = await fetch(capture.endpoint, {
        ...
        body: JSON.stringify({
          ...
          consentType: capture.consentType || 'express',
          consentScope: capture.consentScope || capture.id || config.id,
          consentCaptureMethod: 'form',
          consentCaptureSource: config.id,
          consentTextVersion: capture.consentTextVersion || null,
          privacyNoticeVersion: capture.privacyNoticeVersion || null,
          managePreferencesUrl: capture.managePreferencesUrl || null,
          unsubscribeUrl: capture.unsubscribeUrl || null,
          source: config.id,
