...
export const TOOL_REGISTRY = [
  ...
  },
  {
    id: 'rate-recheck',
    title: 'Rate Recheck',
    description: 'Check whether your pre-approval or borrowing numbers may need a fresh broker-style recheck.',
    group: 'assess',
    tier: 'free',
    priority: 'hero',
    icon: '🔁',
    slug: '/rate-recheck.html',
    legacySlug: '/rate-recheck.html',
    migrated: true,
    inputs: ['approvalAge', 'timing', 'loanSize', 'incomeChange', 'debtChange', 'dti', 'repaymentComfort'],
    outputs: ['recheckSignal', 'nextStep', 'checklistRequest'],
  },
  {
    id: 'mortgage-stress-check',
    title: 'Mortgage Stress Check',
    description: 'Check repayment pressure, 3% buffer sensitivity and refinance space before deciding your next step.',
    group: 'assess',
    tier: 'free',
    priority: 'hero',
    icon: '🩺',
    slug: '/mortgage-stress-check.html',
    legacySlug: '/mortgage-stress-check.html',
    migrated: true,
    inputs: ['loanBalance', 'propertyValue', 'rate', 'income', 'expenses', 'debts', 'refinanceRate'],
    outputs: ['stressSignal', 'bufferGap', 'refinanceSaving', 'nextStep'],
  },
  {
    id: 'macquarie-policy-check',
    title: 'Macquarie Policy Check',
    description: 'Check whether a home-loan scenario looks Macquarie-first on headline policy: LVR, DTI, purpose, entity, income and security fit.',
    group: 'assess',
    tier: 'free',
    priority: 'hero',
    icon: '🏦',
    slug: '/macquarie-policy-check.html',
    legacySlug: '/macquarie-policy-check.html',
    migrated: true,
    inputs: ['purpose', 'loanType', 'loanAmount', 'propertyValue', 'income', 'debt', 'entity', 'incomeType', 'security'],
    outputs: ['macquariePolicySignal', 'effectiveLvrCap', 'dti', 'watchPoints'],
  },
  {
    id: 'dti-router',
    title: 'DTI Router',
