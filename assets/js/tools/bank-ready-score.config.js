  ...
  resolveResult(values) {
    ...
    return {
      ...
      leadCapture: {
        ...
        consentText: 'Send me the Bank-Ready Score document checklist and related general-information follow-up from Oney & Co. I understand I can unsubscribe at any time. This is not credit advice, tax advice or an approval assessment.',
        privacyText: 'We use your email, score result and answers to send this checklist and keep a consent record. No lender submission is made from this tool.',
        submitLabel: 'Send my checklist →',
        successText: '✅ Thanks — your document checklist has been emailed.',
        consentType: 'express',
        consentScope: 'brs_document_integrity_checklist',
        consentTextVersion: BRS_CONSENT_TEXT_VERSION,
        privacyNoticeVersion: BRS_PRIVACY_NOTICE_VERSION,
        managePreferencesUrl: 'mailto:hello@oneyco.com.au?subject=Manage%20Bank-Ready%20Score%20email%20preferences',
        unsubscribeUrl: 'mailto:hello@oneyco.com.au?subject=Unsubscribe%20from%20Bank-Ready%20Score%20emails',
